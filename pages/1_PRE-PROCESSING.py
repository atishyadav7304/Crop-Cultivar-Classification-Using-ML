...
if uploaded_file is not None:
    try:
        # Load the file into session state so it persists across dropdown changes
...
# Only show the dropdown workflow if data is uploaded
if st.session_state.raw_data is not None:
    ...
    # ==========================================
        ...
        # If data has been cleaned, display it
    ...
    # ==========================================
        ...
        # Give user the choice to use Step 2 output OR bypass Step 2
        data_source = st.radio(
            "Select input data for resampling:",
            options=["Use Output from Noise Removal", "Bypass: Use Uploaded File Directly"],
            help="If you uploaded an already cleaned file, select 'Bypass' to resample it directly."
        )
        ...
        # If data has been resampled, display it and show Splitting logic
